...
import com.lildan42.cft.fighterdata.attacks.SmallProjectileType;
...
public class CFT2ModDataComponentTypes implements CFT2Initializer {
    ...
    public static final ComponentType<SmallProjectileType> CFT_SMALL_PROJECTILE_TYPE =
            register("small_projectile_type", builder -> builder
                    .codec(CodecUtils.enumCodec(SmallProjectileType.class))
                    .packetCodec(CodecUtils.enumPacketCodec(SmallProjectileType.values())));
