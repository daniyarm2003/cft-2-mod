...
import com.lildan42.cft.entities.renderers.CFTShurikenEntityRenderer;
...
public class CFT2ModEntitiesClient implements CFT2Initializer {
    ...
    public void initialize(Logger logger) {
        ...
        EntityRendererRegistryImpl.register(CFT2ModEntities.CFT_SHURIKEN, CFTShurikenEntityRenderer::new);
