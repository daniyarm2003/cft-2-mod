...
import com.lildan42.cft.entities.renderers.CFTSmallProjectileEntityRenderer;
...
public class CFT2ModEntitiesClient implements CFT2Initializer {
    ...
    public void initialize(Logger logger) {
        ...
        EntityRendererRegistryImpl.register(CFT2ModEntities.CFT_SMALL_PROJECTILE, CFTSmallProjectileEntityRenderer::new);
